             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 musicButton.addMouseListener(new java.awt.event.MouseAdapter() {
                     public void mouseEntered(java.awt.event.MouseEvent evt) {
                         musicButton.setBackground(Color.yellow); // set the background color to yellow when the mouse enters
                     }
                 ...
                 exitButton.addMouseListener(new java.awt.event.MouseAdapter() {
                     public void mouseEntered(java.awt.event.MouseEvent evt) {
                         exitButton.setBackground(Color.yellow); // set the background color to yellow when the mouse enters
                     }
                 ...
                 saveButton.addMouseListener(new java.awt.event.MouseAdapter() {
                     public void mouseEntered(java.awt.event.MouseEvent evt) {
                         saveButton.setBackground(Color.yellow); // set the background color to yellow when the mouse enters
                     }
